...
In the attributes inspector, next to **System Item**, use the drop down mennu to select the **Add** option. This should turn your button into a `+`.  
...
Then, `ctrl+drag` from the button you 
